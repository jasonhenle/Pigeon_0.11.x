...
|---------|--------|------------|
| **PigeonOS 0.11 (current)** | [`PigeonOS_0.11_Development/Pigeon/`](PigeonOS_0.11_Development/Pigeon/) | `PigeonOS_0.11` (dev) / `main` (release) |
...
| Branch | Purpose |
|--------|---------|
| `PigeonOS_0.11` | Day-to-day PigeonOS 0.11 development |
| `main` | Release line — what Updates / installers pull |
| `experiment` | Legacy 0.8-era working branch (superseded by `PigeonOS_0.10`) |
